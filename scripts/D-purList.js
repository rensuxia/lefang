$(function(){
                                    ...
                                    <ul class="proTD">\
                                        ...
                                        <li class="operation">\
                                            <div>\
                                                ...
                                                <p><a class="cancleOrder" href="#">取消订单</a></p>\
                                            </div>\
                                        </li>\
                                    </ul>\
                                </div>\
    ...
    .done(function(data){
        ...
        for(var i=0;i<data.value.length;i++){
            i<data.value.length-1?createHTML(data.value[i]):createPages(data.value[i]);
        }
    ...
    function createPages(pages_obj){
        console.log(pages_obj);
        var num_pages=Number(pages_obj.pages);
        for(var i=num_pages;i>=1;i--){
            $('.prev').after('<li class="pageBtn"><span>'+i+'</span></li>');
        }

        $('.contentBox').on('click','.go',function(num_pages){
        ...
        $('.contentBox').on('click','.pageBtn',function(){
